...
function taskAction(id,tid,action)
{
	var f='';
	var t='GET';
	...
	$.ajax({
		...
		url:'ajax/commonAjax.php?action='+action+'&taskid='+tid,
		type:'POST',
		data:f,
		success:function(msg){
			if(action == 'addBid')
	...
	$.ajax({
		...
		success:function(msg){ 
                                ...
                                if(msg==1){
                                    ...
                                    if(!confirm("You have not add any payment method. Add Now !"))                                        {
                                                return false;
                                        }else{
                                            window.location='/card_detail.php';
                                            return false;
                                        }
                                }
				else if(msg != 'false')
