...
try{
	         ...
	         $rp->tax_id=$_POST['tax-id'];
                ...
                $data =$rp->active_account;
                 ...
                 $update = mysql_query("update admin_bank_details set `bankid` ='".$data->id."' where recipientid ='".$_POST['id']."' && secretkey = '".$sresult['secretkey']."'");
                echo 'Done successfully';
                header('Refresh: 2; URL=http://'.$_SERVER['HTTP_HOST'].'/admin/servicefee.php');
    ...
    <div class="row">
            <div class="col-lg-6">
                <div class="panel panel-primary">
                 <a style="background: none repeat scroll 0 0 #2980b9;border-radius: 5px;color: #fff;float: right;margin: 1px;padding: 8px 17px;text-decoration: none;" href="servicefee.php">Back</a>
